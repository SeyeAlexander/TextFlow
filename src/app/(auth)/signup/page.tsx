...
export default function SignupPage() {
  ...
  return (
    <>
      {/* Header */}
      <div className='mb-8'>
        <h1 className='font-korium mb-1 text-xl font-medium'>Create your account</h1>
        <p className='text-sm text-muted-foreground'>Start collaborating on documents in seconds</p>
      </div>
