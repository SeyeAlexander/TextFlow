    ...
    <div className='w-4/6 py-4'>
      <div className='rounded-2xl bg-black/5 p-1.5 pt-4 dark:bg-white/5'>
        <div className='mx-2 mb-2.5 flex items-center gap-2'>
          ...
          <p className='text-orange-500 text-xs tracking-tighter font-medium'>Ship Now!</p>
        </div>
        <div className='relative'>
          <div className='relative flex flex-col'>
            <div className='overflow-y-auto' style={{ maxHeight: "400px" }}>
              <Textarea
                className={cn(
                  "w-full resize-none rounded-xl rounded-b-none border-none bg-black/5 px-4 py-3 placeholder:text-black/70 focus-visible:ring-1 focus-visible:ring-blue-500/50 focus-visible:ring-offset-0 dark:bg-white/5 dark:text-white dark:placeholder:text-white/70",
                  "min-h-[72px]",
                )}
                id='ai-input-15'
                onChange={(e) => {
