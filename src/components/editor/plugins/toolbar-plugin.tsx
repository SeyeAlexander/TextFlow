...
export function ToolbarPlugin() {
  ...
  return (
    <div className='absolute top-4 right-4 z-20 flex items-center gap-1 rounded-lg border border-black/5 bg-white p-1 shadow-sm dark:border-white/5 dark:bg-[#1a1a1a]'>
      <button
        onClick={() => {
