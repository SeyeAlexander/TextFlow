CREATE TYPE "public"."chat_type" AS ENUM('dm', 'group');--> statement-breakpoint
...
ALTER TABLE "chat_participants" ADD CONSTRAINT "chat_participants_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
